...
namespace nvidiaProfileInspector.Common.Meta
{
    ...
    public class DriverSettingMetaService : ISettingMetaService
    {
        ...
        private List<uint> InitSettingIds()
        {
            ...
            var nvRes = nvw.Instance.DRS_EnumAvailableSettingIds(out settingIds, 512);
        ...
        private SettingMeta GetDriverSettingMetaInternal(uint settingId)
        {
            ...
            uint valueCount = 255;
            var nvRes = nvw.Instance.DRS_EnumAvailableSettingValues(settingId, ref valueCount, ref values);
            ...
            nvRes = nvw.Instance.DRS_GetSettingNameFromId(settingId, sbSettingName);
            if (nvRes != NvAPI_Status.NVAPI_OK)
