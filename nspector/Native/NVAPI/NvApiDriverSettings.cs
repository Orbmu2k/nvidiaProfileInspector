namespace nspector.Native.NvApi.DriverSettings
{
	...
	public enum EValues_PS_FRAMERATE_LIMITER : uint {
		...
		PS_FRAMERATE_LIMITER_MASK = 0xf0ef80ff,
	...
	public enum EValues_QUIET_MODE : uint {
		QUIET_MODE_MIN = 0x00000001,
		QUIET_MODE_MAX = 0x000000ff,
		QUIET_MODE_ENABLED = 0x10000000,
		QUIET_MODE_DISABLED = 0x00000000,
		QUIET_MODE_NUM_VALUES = 4,
		QUIET_MODE_DEFAULT = QUIET_MODE_DISABLED
	}
	...
	public enum EValues_NLS_ALLOW : uint {
	...
	public enum EValues_NLS_ENABLE : uint {
		NLS_ENABLE_OFF = 0,
		NLS_ENABLE_ON = 1,
