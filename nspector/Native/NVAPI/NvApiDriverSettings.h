#ifndef C:\USERS\NATHANB\RIDERPROJECTS\NVIDIAPROFILEINSPECTOR\NSPECTOR\NATIVE\NVAPI\NVAPIDRIVERSETTINGS_H
#define C:\USERS\NATHANB\RIDERPROJECTS\NVIDIAPROFILEINSPECTOR\NSPECTOR\NATIVE\NVAPI\NVAPIDRIVERSETTINGS_H
...
enum EValues_SLI_PREDEFINED_MODE
{
    ...
    SLI_PREDEFINED_MODE_FORCE_AFR_OF_SFR_FALLBACK_3AFR = 0x00000005,
...
enum EValues_SLI_PREDEFINED_MODE_DX10
{
    ...
    SLI_PREDEFINED_MODE_DX10_FORCE_AFR_OF_SFR_FALLBACK_3AFR = 0x00000005,
...
enum EValues_SLI_RENDERING_MODE
{
    ...
    SLI_RENDERING_MODE_FORCE_AFR_OF_SFR_FALLBACK_3AFR = 0x00000005,
...
using SettingDWORDNameString = struct _SettingDWORDNameString
{
    NvU32 settingId;
...
using SettingWSTRINGNameString = struct _SettingWSTRINGNameString
{
    NvU32 settingId;
    const wchar_t* settingNameString;
    NvU32 numSettingValues;
...
#endif // C:\USERS\NATHANB\RIDERPROJECTS\NVIDIAPROFILEINSPECTOR\NSPECTOR\NATIVE\NVAPI\NVAPIDRIVERSETTINGS_H
